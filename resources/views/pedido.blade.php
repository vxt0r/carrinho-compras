...
@section('content')
<h3 class="text-center text-white">Seu pedido foi realizado com sucesso</h3>
...
<div class="mx-auto mt-4 text-center">
    <a href="{{route('carrinho.limpar',['id'=> $carrinho[0]->id])}}" class="text-white">Voltar para o carrinho</a>
</div>
@endsection